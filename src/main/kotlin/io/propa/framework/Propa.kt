...
//    try {
      val rootElement = document.getElementsByTagName("propa-app")[0]
      rootElement!!.removeAllChildren()
      PropaDomBuilder.buildComponent(componentInstance)
      PropaDomBuilder.patch(rootElement, componentInstance.vnode)
//    } catch (e: Exception){
